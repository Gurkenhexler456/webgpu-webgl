...
export class SolarEngine_WebGL extends SolarEngine {
    ...
    /**
     * @type {ScreenSpace_Downscale_WebGL}
     */
    #downscaler;
    ...
    async init() {
        ...
        this.#downscaler = new ScreenSpace_Downscale_WebGL(this.#light_renderer.light_texture, light_resolution);

        this.#horizontal_blur = new ScreenSpace_Blur_WebGL(
            this.#downscaler.output,
